...
//         // Calculate the scaled width and height to fit the page with margins
//         var margin = 72; // 1 inch = 72 points
//         var imageWidth = pageWidth - 0 * margin;
//         var imageHeight = pageHeight - 0 * margin;
